module.exports = {
  ...
  namnsdag_nu: require(`./namnsdag_nu.js`),
  namnsdag_eu: require(`./namnsdag_eu.js`),
  aftonbladet_se: require(`./aftonbladet_se.js`),
  sprakochfolkminnen_se: require(`./sprakochfolkminnen_se.js`)
}
